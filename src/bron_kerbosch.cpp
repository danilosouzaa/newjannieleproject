...
void bk_set_timelimit(BronKerbosch *bk, double timelimit)
{
    bk->timeLimit = timelimit;
    bk->bkg->setTimelimit(timelimit);
}

void bk_set_max_cliques(BronKerbosch *bk, int maxCliques)
{
    bk->maxCliques = maxCliques;
    bk->bkg->setMaxCliques(maxCliques);
}
