...
CFLAGS="-O2 -g -pg -flto -fopenmp -std=c99"
CPPFLAGS="-O2 -g -pg -flto -fopenmp -DCPX -I/opt/ibm/ILOG/CPLEX_Studio1263/cplex/include/ilcplex/"
LDFLAGS="-O2 -g -pg -L/opt/ibm/ILOG/CPLEX_Studio1263/cplex/lib/x86-64_linux/static_pic/ -flto -lm -fopenmp -lpthread -lcplex"
