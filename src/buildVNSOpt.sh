...
CPPFLAGS="-Ofast -flto -fopenmp -DCPX -I/opt/ibm/ILOG/CPLEX_Studio1263/cplex/include/ilcplex/"
LDFLAGS="-Ofast -L/opt/ibm/ILOG/CPLEX_Studio1263/cplex/lib/x86-64_linux/static_pic/ -flto -lm -fopenmp -lpthread -lcplex"
...
neighborhood.c rrusage.c vns.c vnd.c learning.c test.c list_int.c lahc.c"
#CPPSOURCES="lp.cpp"
BINDIR=./bin/opt/
...
echo linking ...
    command="${CPP}  ${lnkFiles} ${LDFLAGS} -o ${BINDIR}/pspvns"
    printf "\t$command\n"
    $command
